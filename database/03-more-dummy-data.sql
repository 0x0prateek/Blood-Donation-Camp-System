...
-- donor_id is NULL for the last three rows: 02-dummy-data.sql only seeds
-- donors 1-5, and message_logs.donor_id has a foreign key into donors,
-- so referencing ids 11-13 would fail on every fresh install.
...
(NULL, '0711111111', 'WhatsApp', 'Urgent O+ blood needed at General Hospital.', 'Sent', '2024-04-05 10:00:00'),
(NULL, '0711111112', 'WhatsApp', 'Urgent O+ blood needed at General Hospital.', 'Sent', '2024-04-05 10:00:01'),
(NULL, '0711111113', 'SMS', 'Urgent O+ blood needed at General Hospital.', 'Sent', '2024-04-05 10:00:02');
